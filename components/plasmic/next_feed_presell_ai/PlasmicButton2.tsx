...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: JkSHdKwObBEwAc/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: tQDJDmg0X8tnzw/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__mdEV)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__z0ZoO)}
                role={"img"}
              />
            ),
